...
class _RecordDetailScreenState extends State<RecordDetailScreen>
  ...
  void initState() {
    ...
    // 使用 AnimationMixin 初始化基本動畫
    initializeAnimations(
      duration: Duration(milliseconds: 1200),
      curve: Curves.easeOut,
      slideCurve: Curves.easeOut,
      slideBegin: Offset(0, 0.1), // 調整為更適合的滑動效果
    );
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Transform.translate(
          offset: Offset(0, -50 * (1 - fadeAnimation.value)),
          child: Opacity(
...
// 修復後的 _buildSharedUsersList 方法
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: vm.users.isEmpty
                    ? 100
                    : (vm.users.length * 70.0).clamp(100.0, 250.0),
                decoration: BoxDecoration(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(15),
                  border: Border.all(
                      color: Color.fromARGB(255, 228, 229, 231), width: 2),
                ),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 16, color: Color.fromARGB(255, 35, 50, 65)),
                    ),
  ...
  Widget _buildTextField(TextEditingController controller, String hint) {
    return TextField(
      ...
      style: TextStyle(
        color: const Color.fromARGB(255, 6, 6, 6), // 輸入文字顏色
        fontSize: 18, // 字體大小
      ),
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Color.fromARGB(255, 250, 252, 254),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide:
              BorderSide(color: Color.fromARGB(255, 1, 8, 15), width: 2),
        ),
          ...
          children: [
            Expanded(
                child: _buildMeasurementCard(
                    ...
                    "公分 (cm)",
                    () => _editMeasurement("身高", _heightController))),
            SizedBox(width: 15),
            Expanded(
                child: _buildMeasurementCard(
                    "⚖️",
                    ...
                    "公斤 (kg)",
                    () => _editMeasurement("體重", _weightController))),
          ],
        ),
      ],
    );
  ...
  Widget _buildMeasurementCard(
      String icon, String value, String label, VoidCallback onTap) {
